...
export default function HomePage() {
  ...
  const techStack = [
    { name: 'Next.js 14', color: '#38bdf8' },
    { name: 'NestJS', color: '#a855f7' },
      ...
      <section className="relative z-10 min-h-screen flex items-center justify-center px-6 pt-16">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-300">
            <Link href={`/${locale}/register`} className="btn-cyber">
              {t('home.cta.start')}
              <svg
                className="w-4 h-4"
                fill="none"
          ...
          <div className="mt-16 pt-8 border-t border-white/5 animate-fade-in-up delay-400">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              {techStack.map((tech) => (
                <div
                  key={tech.name}
                  className="flex items-center gap-2 px-4 py-2 bg-white/4 border border-white/8 hover:border-[#a855f7]/40 hover:bg-[#a855f7]/8 transition-all duration-300 rounded-xl"
                >
                  <div
          ...
          <div className="space-y-8">
            {steps.map((item, index) => (
              <div key={index} className="flex items-start space-x-6 group">
                <div className="text-5xl font-bold text-[#a855f7]/20 font-['Orbitron'] w-24 flex-shrink-0 group-hover:text-[#a855f7]/50 transition-colors">
                  {item.step}
                </div>
                <div className="pt-1 flex-grow border-l border-white/5 pl-6 group-hover:border-[#a855f7]/30 transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Image src="/static/logo.png" alt="Logo" width={24} height={24} />
              <span className="font-['Orbitron'] text-xs tracking-wider text-gray-500">
                © {new Date().getFullYear()} NESTNEXT
              </span>
            </div>
            <div className="flex items-center gap-6">
              <a
                href="/docs"
                className="font-['Orbitron'] text-xs tracking-wider text-gray-500 hover:text-[#a855f7] transition-colors"
              >
                {t('api.documentation')}
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-['Orbitron'] text-xs tracking-wider text-gray-500 hover:text-[#38bdf8] transition-colors"
              >
                GITHUB
              </a>
            </div>
